...
const TeacherCourseListing = () => {
    ...
    const courses = useSelector((state) =>
        filterCourses(
            state.courseReduser.teacherCourses,
...
export default TeacherCourseListing;
