...
import { deleteGroup } from 'src/store/apps/groups/GroupSlice';
...
function Row(props: { row: GroupType; id: number }) {
    const { row, id } = props;
    ...
    const handleGroupDeletion = () => {
        try {
            dispatch(deleteGroup(row.id ? row.id.toString() : ''));
...
const EditGroupTable = ({ groups }: { groups?: GroupType[] }) => {
                        ...
                        <Table stickyHeader aria-label="sticky table">
                            <TableHead color="primary.main">
                                ...
                                >
                                    ...
                                    <TableCell width={'180px'} >
                                            <ButtonBase onClick={() => setCreateGroup(true)}>
